									...
									<div style="margin-left: 0px;">  
									  <div class="col-md-12" style="width:96%">
										<form id="form1" class="form-horizontal col-md-12" action="input_soal_pilihanganda.php?id=<?php echo $id ?>" method="post">
										  ...
										  <div class="row" style="padding-right:330px;">
											  <div style="background-color:#ffbf30">
												<p style="margin-left:5px; font-size:14px; color:#fff; margin-top:10px;">Klik huruf didalam lingkaran untuk menetapkan jawaban yang benar</p>
											  </div>
										  </div>
									  ...
									  <div class="col-md-12" style="width:96%">
										<form id="form4" class="form-horizontal col-md-12" action="input_soal_bs.php?id=<?php echo $id; ?>" method="post">
										  ...
										  <div class="row" style="padding-right:400px;">
											  <div style="background-color:#ffbf30">
												<p style="font-size:14px; color:#fff; margin-top:10px;">Klik lingkaran untuk menetapkan jawaban yang benar</p>
											  </div>
										  </div>
